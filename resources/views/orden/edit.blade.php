...
@section('name','..|Procesar Orden de Venta|..')
...
@include('modals.condiciones')
  ...
  <!-- Left col -->
          <section class="col-lg-12 connectedSortable" id="section-body" style="display: none">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Proceso de compra y facturacion
                </h3>
           ...
           <form action="{{url('orden/procesar')}}" id="formulario-aprobar" method="post" enctype="multipart/form-data">
              {{csrf_field()}}
    ...
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
          <label for="">&nbsp;</label>
            <button type="button" onclick="guardar('formulario-aprobar');" class="btn btn-success">Procesar Orden</button>
          </div>
        </div>  
