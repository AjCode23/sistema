...
@endif
              ...
              <form action="{{url('categorias/update',$categoria->id)}}" id="formulario" method="post" >
              	{{ csrf_field()}}
              ...
              <div class="card-body p-0">
                <div class="bs-stepper">
                  ...
                  <div class="alert alert-success">
                  	Debes completar todos los datos obligatorios para poder Modificar la Categoria!
                  </div>
                  <hr>
                    ...
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      ...
                      <div class="row">
                      	<div class="col-md-6">
                      		...
                      		<input class="form-control" value="{{$categoria->categoria}}" type="text" name="categoria" id="idpersona" required>
                      	</div>
                      	<div class="col-md-6">
                      		<label for="">Descripcion <b class="text-red">(*)</b></label>
                      		<input class="form-control" value="{{$categoria->descripcion}}" type="text" name="descripcion" id="idpersona" required>
