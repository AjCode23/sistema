...
/
 <a class="link" title=""><i class="mdi mdi-account-location"></i> Registrar Cliente</a>
@endsection
          ...
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-edit"></i> Nueva Categoria</h3>

                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link btn-outline-danger active " style="color: #fff !important" href="{{url('categorias')}}" ><i class="mdi mdi-reply"></i> Cancelar</a>
                    </li>
                      &nbsp;
              ...
              <div class="card-body p-0">
                <div class="bs-stepper">
                  <div class="bs-stepper-header" role="tablist">
                    ...
                    <div class="step" data-target="#logins-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                        ...
                        <span class="bs-stepper-label">Datos Categoria</span>
                      </button>
                    </div>
                  ...
                  <div class="alert alert-success">
                  	Debes completar todos los datos obligatorios para poder Registrar la Categoria!
                  </div>
                  <hr>
                  <div class="bs-stepper-content">
                    ...
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      ...
                      <div class="row">
                      	<div class="col-md-6">
                      		<label for="">Categoria <b class="text-red">(*)</b></label>
                      		<input class="form-control"  type="text" name="categoria" id="idpersona" required>
                      	</div>
                      	<div class="col-md-6">
                      		<label for="">Descripcion <b class="text-red">(*)</b></label>
                      		<input class="form-control"  type="text" name="descripcion" id="idpersona" required>
...
<br>
	...
	<div class=" col-md-offset-5 col-md-3">
                       ...
                       <button type="submit" onclick="" class="btn btn-outline-success">Registrar</button>
	</div>
                    </div>
