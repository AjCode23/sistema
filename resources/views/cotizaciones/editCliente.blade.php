...
/
 <a class="link" title=""><i class="mdi mdi-account-location"></i> Aprobar Cotizacion</a>
@endsection
...
Swal.fire({
  ...
  text: "Esta usted seguro de Guardar la cotizacion!",
  icon: 'warning',
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  @include('alerts')
                  <form id="form-guardar" action="{{url('cotizaciones/update/orden')}}" method="post">
                  	{{csrf_field()}}
                 ...
                 <textarea disabled style="background: #fff;" class="form-control" value="">{{$orden->comentario}}</textarea><br>
             </div>


              <div class="col-md-12">
                      <label for=""> Documentos de Respaldo </label><br>
                      @foreach($orden->archivos as $a)
                     <a class=" btn btn-outline-primary" target=”_blank” href="{{url('archivos/'.$a->archivo)}}">{{$a->archivo}}</a>
                      @endforeach
...
<div id="btns" style="display: none">
	...
	<button  class="btn btn-danger" onclick="guardar();" style="background: #781428; "><i class="fa fa-database"></i> Guardar Observaciones</button>
	<button  class="btn btn-danger" onclick="cancelar();" ><i class="mdi mdi-close"></i> Cancelar</button>
</div>
