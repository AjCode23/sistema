...
@section('name','..|Ordenes de Venta |..')

@section('ol')
 <a style="color: #e68618;" href="{{url('home')}}" class="link" title=""><i class="mdi mdi-home"></i> Home
</a>
/
 <a class="link" title=""><i class="mdi mdi-account-location"></i> Ordenes de Venta</a>
@endsection
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                 ...
                 <tr>
                  ...
                  @if($o->cotizacion->cliente->id == Auth::user()->cliente->id && $o->status == 3 )
                  <tr>
                    <td> 
                      <button onclick="mostrar({{$o->id}})" class="btn btn-outline-primary btn-xs"><i class="mdi mdi-eye"></i></button>
                     
                      
                      <a href="{{url('orden/pdf',$o->id)}}" title="Imprimir Orden de Venta" class="btn btn-outline-secondary btn-xs"><i class="mdi mdi-file-pdf"></i></a>
