...
@section('name','..|Registrar Cliente|..')
 
@section('ol')
 <a style="color: #e68618;" href="{{url('home')}}" class="link" title=""><i class="mdi mdi-home"></i> Home
</a>
/
 <a class="link" title=""><i class="mdi mdi-account-location"></i> Nuevo Cliente</a>
@endsection
...
function banca(btn){
	...
	if(cont >=0  && cont <= 5){
		...
		$('#mas_bancos').append(`
			  <div class="row">
                     	<div class="col-md-3">
                     		<label for="">Tipo Telefono</b></label>
                        ...
                        <input class="form-control" type="number" name="numero_cuenta[]"   placeholder="Numero de Cuenta" >
                     	</div>
...
function nobanco(){
	var cont=parseFloat($('#btn_banca').val());
			 ...
			 <div class="row">
                     	<div class="col-md-5">
                     		<label for="">Moneda <b class="text-red">(*)</b></label>
		                      <input class="form-control" type="text" name="moneda[]"   placeholder="Moneda" required>
                     	</div>
...
function nomoney(){
	var cont=parseFloat($('#btn_money').val());
          ...
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-plus"></i> Nuevo Cliente</h3>
...
@endif
              ...
              <form action="{{url('clientes')}}" id="formulario" method="post" >
              	{{ csrf_field()}}
              ...
              <div class="card-body p-0">
                <div class="bs-stepper">
                  <div class="bs-stepper-header" role="tablist">
                    ...
                    <div class="step" data-target="#information-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="information-part" id="information-part-trigger">
                        <span class="bs-stepper-circle"><i class="fa fa-phone"></i></span>
                        <span class="bs-stepper-label">Telefonos Principales</span>
                      </button>
                    </div>
                    ...
                    <div class="step" data-target="#regimen">
                      <button type="button" class="step-trigger" role="tab" aria-controls="regimen" id="information-part-trigger">
  					  ...
  					  <div class="line"></div>
                    <div class="step" data-target="#bancaria">
                      <button type="button" class="step-trigger" role="tab" aria-controls="bancaria" id="information-part-trigger">
                        <span class="bs-stepper-circle"><i class="mdi mdi-bank"></i></span>
                        <span class="bs-stepper-label">Banco</span>
                      </button>
                    </div>
                    ...
                    <div class="line"></div>
                    <div class="step" data-target="#comercio">
                      <button type="button" class="step-trigger" role="tab" aria-controls="information-part" id="information-part-trigger">
                        <span class="bs-stepper-circle"><i class="fa fa-users"></i></span>
                        <span class="bs-stepper-label">Contacto Comercial</span>
                      </button>
                    </div>
                  ...
                  <div class="alert alert-success">
                  	Debes completar todos los datos obligatorios para poder registrar el cliente!
                  </div>
                  <hr>
                    ...
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      ...
                      <div class="row">
                      	<div class="col-md-4">
                      		...
                      		<input class="form-control" type="text" name="nombres" id="idpersona" required>
                      	</div>
                      	<div class="col-md-2">
                      	...
                      	<div class="col-md-2">
                     		 ...
                     		 <input class="form-control" type="text" name="numDocumento" id="num_documento" maxlength="20" placeholder="Número de Documento" required>
                      	</div>
                      	<div class="col-md-2">
                      		 <label for="">Actividad Principal <b class="text-red">(*)</b></label>
                         	 <input class="form-control" type="text" name="actividad_ppal" id="actividad_ppal" maxlength="50" placeholder="Actividad principal del cliente" required>

                      	</div>

                      	<div class="col-md-2">
                      		 <label for="">Correo <b class="text-red">(*)</b></label>
                         	 <input class="form-control" type="email" name="email" id="email" maxlength="50" placeholder="Correo del Cliente" required>
...
<br>
                        ...
                        <input class="form-control" type="text" name="direccion" id="direccion" maxlength="70" placeholder="Direccion" required>
                      	...
                      	<div class="col-md-2">
		                     ...
		                     <select class="form-control select-picker" name="tipo_persona" id="tipo_documento" required>
                       ...
                       <select name="pais" required  class="form-control">
                        ...
                        <input class="form-control" type="text" name="departamento" id="departamento" maxlength="70" placeholder="Departamento" required>
                      	</div>
	...
	<br>
                        ...
                        <input class="form-control" type="text" name="ciudad" id="ciudad" maxlength="70" placeholder="Ciudad" required>

                      	</div>

                      		<div class="col-md-4">
                      		  <label for="">Código Postal <b class="text-red">(*)</b></label>
                        	<input class="form-control" type="text" name="codigo_postal" id="codigo_postal" maxlength="70" placeholder="Código Postal" required>
                      	</div>


                      	<div class="col-md-4">
                      		  <label for="">Asesor Comercial <b class="text-red">(*)</b></label>
                     ...
                     <div class="row">
                        ...
                        <input class="form-control" type="number" name="numero[]"   placeholder="Numero Telefonico" required>
                     	...
                     	<div class="col-md-4">
                     		...
                     		<button type="button" class="btn btn-warning mt-8" onclick='tlf()' style="margin-top: 20px;"><i class="fa fa-plus"></i></button>
                    ...
                    <div id="regimen" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                     ...
                     <div class="row">
                     	<div class="col-md-4">
		                     ...
		                     <select class="form-control select-picker" name="tipoRegimen" id="tipo_tlf" required>
                        ...
                        <input class="form-control" type="text" name="resolucion"   placeholder="Numero de Resolucion" required>
                     	</div>
                        ...
                        <input class="form-control" type="text" name="ciu"   placeholder="Codigo ciu" required>
                     	</div>
					 ...
					 <div id="bancaria" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                     	<input type="hidden" name="numTlf" id="contadorBanco" value="0">
                     ...
                     <div class="row">
                        ...
                        <input class="form-control" type="number" name="numero_cuenta[]"   placeholder="Numero de Cuenta" required>
                     	</div>
                        ...
                        <select class="form-control select-picker" name="banco[]" id="banco" required>
                     	...
                     	<div class="col-md-2">
                     		<label for=""><br>&nbsp; <br></label>
                     		<button type="button" class="btn btn-warning mt-8" id="btn_banca" value="0" onclick='banca(this)' style="margin-top: 20px;"><i class="fa fa-plus"></i></button>

                     		<button type="button" class="btn btn-default mt-8" onclick='nobanco()' style="margin-top: 20px;"><i class="fa fa-trash"></i></button>
                     	</div>
                  
                     </div>
                     <div id="mas_bancos"></div>
                     ...
                     <div class="row">
                     	<div class="col-md-3">
                     		<label for="">Correo Facturación Electronica<b class="text-red">(*)</b></label>
		                      <input class="form-control" type="email" name="dir_factura[]"   placeholder="correo de facturacion" required>
                     	</div>
                     	<div class="col-md-4">
                     		 <label for="">Direccion de Recibo <b class="text-red">(*)</b></label>
                        <input class="form-control" type="text" name="dir_equipo[]"   placeholder="direccion equipo" required>
                     	</div>

                     	<div class="col-md-3">
                     		 <label for="">Fecha Maxima de Recepción <b class="text-red">(*)</b></label>
                         <input class="form-control" type="date" name="fecha_fact[]"   placeholder="" required>
                     	</div>
                     ...
                     <div id="monedas" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                        ...
                        <input class="form-control" type="number" name="activo" id="" maxlength="70" placeholder="" required>

                      	</div>

                      		<div class="col-md-4">
                      		  <label for="">Pasivos <b class="text-red">(*)</b></label>
                        	<input class="form-control" type="number" name="pasivo" id="" maxlength="70" placeholder="" required>
                      	</div>


                      	<div class="col-md-4">
                      		  <label for="">Patrimonios <b class="text-red">(*)</b></label>
                        	<input class="form-control" type="number" name="patrimonio" id="" maxlength="70" placeholder="" required>
                      	</div>
                      ...
                      <br>
                        ...
                        <input class="form-control" type="number" name="ingreso" id="" maxlength="70" placeholder="" required>

                      	</div>

                      		<div class="col-md-4">
                      		  <label for="">Egresos Mensuales <b class="text-red">(*)</b></label>
                        	<input class="form-control" type="number" name="egreso" id="" maxlength="70" placeholder="" required>
                      	</div>


                      	<div class="col-md-4">
                      		  <label for="">Otros <b class="text-red">(*)</b></label>
                        	<input class="form-control" type="number" name="otros" id="" maxlength="70" placeholder="" required>
                      	</div>
                     ...
                     <div class="row">
                     	...
                     	<div class="col-md-2">
                     		<label for=""><br>&nbsp; <br></label>
                     		<button class="btn btn-warning mt-8" type="button" id="btn_money" value="0" onclick='money(this)' style="margin-top: 20px;"><i class="fa fa-plus"></i></button>

                     		<button class="btn btn-default mt-8" type="button" onclick='nomoney()' style="margin-top: 20px;"><i class="fa fa-trash"></i></button>
                     	</div>
                  
                     </div>
                     <div id="mas_money"></div>
                     ...
                     <div id="comercio" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                     	<input type="hidden" name="numComercio" id="contComercio" value="0">
                      <div class="row">
                     	<div class="col-md-3">

                     		 <label for="">Nombre Contacto Comercial <b class="text-red">(*)</b></label>
                        <input class="form-control" type="text" name="nombreCom[]"   placeholder="Nombre contacto comercial" required>
                     	</div>
                     	<div class="col-md-3">
                     		 <label for="">Correo Contacto <b class="text-red">(*)</b></label>
                        <input class="form-control" type="email" name="emailCom[]"   placeholder="Correo contacto" required>
                     	</div>
                     	<div class="col-md-2">
                        ...
                        <input class="form-control" type="number" name="tlfPerCom[]"   placeholder="Numero personal" required>
                     	...
                     	<div class="col-md-2">
                     		<label for=""><br>&nbsp; <br></label>
                     		<button class="btn btn-warning mt-8" onclick='comercio()' style="margin-top: 20px;"><i class="fa fa-plus"></i></button>
                     		<button class="btn btn-default mt-8" onclick='nocomercio()' style="margin-top: 20px;"><i class="fa fa-trash"></i></button>
                     	</div>
                  
                     </div>
                     <div id="masComercio"></div>

                     <br>
                      <button type="button" class="btn btn-outline-secondary" onclick="stepper.previous()">Regresar</button>
                  
                      <button type="submit" onclick="" class="btn btn-outline-success">Guardar</button>
                    </div>
