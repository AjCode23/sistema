...
<center>
	<h2 class=" bold orange"> COTIZACION NO. 	
								@if($orden->id < 10)
        					  		{{"00000".$orden->id}}
        					  	@elseif($orden->id < 100){
        					  		{{"0000".$orden->id}}
...
<h3>Hola!.. Asesor, {{$orden->asesor->nombre}}</h3>
<p>  <div style="  width:95%; 
                     background: rgba(60, 141, 188, 0.28); padding: 10px; border: 1px solid rgba(60, 141, 188, 0.54); color: #3784af; font-weight: bold; ">
                       Estimado Asesor, El cliente ya aprobo la cotizacion con las siguientes Caracteristicas!
                    </div></p>
...
<hr>
<p>Debes Aceptar esta Orden de Venta  <a href="{{url('/logout')}}"> Aqui</a> para poder realizar la Orden de Compra </p>
