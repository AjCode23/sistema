...
@section('name','..|Registrar Permiso|..')

@section('ol')
 <a style="color: #e68618;" href="{{url('home')}}" class="link" title=""><i class="mdi mdi-home"></i> Home
</a>
/
 <a class="link" title=""><i class="mdi mdi-account-location"></i> Registrar Permiso</a>
@endsection
          ...
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-edit"></i> Nuevo Permiso</h3>
...
@endif
              ...
              <form action="{{url('permisos')}}" autocomplete="off" method="post" >
              	{{ csrf_field()}}
              ...
              <div class="card-body p-0">
                <div class="bs-stepper">
                  ...
                  <div class="alert alert-success">
                  	Debes completar todos los datos obligatorios para poder Registrar el Permiso!
                  </div>
                  <hr>
                    ...
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      ...
                      <div class="row">
                      	<div class="col-md-6">
                      		...
                      		<input class="form-control"  type="text" name="permiso" id="idpersona" required>
                      	</div>
